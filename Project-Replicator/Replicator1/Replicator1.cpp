...
#pragma endregion
	...
	fd_set readfds;			// struktura u koju stavljamo sve sokete na kojima se moze desiti neki dogadjaj
...
#pragma region Accept
	...
	while (pom)
	{
		...
		else if (FD_ISSET(listenSocket, &readfds))		// Dogadjaj na listen socket-u, neko hoce da se poveze
		{
			...
			*params->doWork = true;
			...
			else
			{
				...
				// socket za slanje na replikator 2
				...
				else
				{
					...
					// socket za prijem sa replikatora 2
